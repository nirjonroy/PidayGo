...
@section('content')
@include('frontend.partials.page-banner', ['title' => 'Edit Profile'])
                                        ...
                                        <div class="tab-1">
                                            <div class="row wow fadeIn">
                                                ...
                                                <div id="sidebar" class="col-lg-4">
                                                    ...
                                                    <img src="{{ asset('frontend/images/author_single/author_thumbnail.jpg') }}" id="click_profile_img" class="d-profile-img-edit img-fluid" alt="">
                                                    ...
                                                    <img src="{{ asset('frontend/images/author_single/author_banner.jpg') }}" id="click_banner_img" class="d-banner-img-edit img-fluid" alt="">

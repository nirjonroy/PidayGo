                            ...
                            <table class="table de-table table-rank">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-7.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            DigiPunks</th>
                                        <td>9,219.13</td>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-8.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            RockToonz</th>
                                        <td>8,436.15</td>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-9.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            BeeFriends</th>
                                        <td>7,505.16</td>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-10.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            Patternlicious</th>
                                        <td>6,593.91</td>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-11.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            FlyingFox</th>
                                        <td>5,605.97</td>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="coll_list_pp">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-12.jpg') }}" alt="">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            Autoglyphs</th>
                                        <td>4,904.27</td>

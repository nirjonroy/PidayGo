...
class SiteSettingController extends Controller
{
    ...
    private function validatePayload(Request $request): array
    {
        return $request->validate([
            ...
            'nav_home_label' => ['nullable', 'string', 'max:80'],
            'nav_explore_label' => ['nullable', 'string', 'max:80'],
            'nav_rankings_label' => ['nullable', 'string', 'max:80'],
            'nav_marketplace_label' => ['nullable', 'string', 'max:80'],
            'nav_profile_label' => ['nullable', 'string', 'max:80'],
            'nav_dashboard_label' => ['nullable', 'string', 'max:80'],
            'nav_wallet_label' => ['nullable', 'string', 'max:80'],
            'nav_deposit_label' => ['nullable', 'string', 'max:80'],
            'nav_withdrawals_label' => ['nullable', 'string', 'max:80'],
            'nav_stake_label' => ['nullable', 'string', 'max:80'],
            'nav_reserve_label' => ['nullable', 'string', 'max:80'],
            'nav_notifications_label' => ['nullable', 'string', 'max:80'],
            'nav_support_label' => ['nullable', 'string', 'max:80'],
            'nav_profile_settings_label' => ['nullable', 'string', 'max:80'],
            'nav_login_label' => ['nullable', 'string', 'max:80'],
            'nav_register_label' => ['nullable', 'string', 'max:80'],
            'nav_logout_label' => ['nullable', 'string', 'max:80'],
            'nav_mobile_dashboard_label' => ['nullable', 'string', 'max:80'],
            'nav_mobile_marketplace_label' => ['nullable', 'string', 'max:80'],
            'nav_mobile_reserve_label' => ['nullable', 'string', 'max:80'],
            'nav_mobile_stake_label' => ['nullable', 'string', 'max:80'],
            'nav_mobile_wallet_label' => ['nullable', 'string', 'max:80'],
